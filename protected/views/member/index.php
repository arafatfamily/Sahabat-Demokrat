...
Yii::app()->clientScript->registerScript('search', "
	...
	$('#Member_reference').keyup(function(){
		  loadData();
		return false;
	});
");
...
<div class="col-xs-12">
	<section class="box ">
		<header class="panel_header">
			<h2 class="title pull-left">DATA ANGGOTA</h2>
			...
			<button id="search-button" class="btn btn-md btn-info" type="button">&nbsp;Pencarian Lanjutan&nbsp;<span class="fa fa-search-plus"></span></button>
			</div>
		</header>
...
function downloadData() {
	window.location.href = "<?php echo CController::createUrl('member/export') ?>?" + $('#filter-form').serialize();
}
</script>