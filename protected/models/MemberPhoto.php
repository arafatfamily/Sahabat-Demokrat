...
/**
 * This is the model class for table "member_photo".
 *
 * The followings are the available columns in table 'member_photo':
 * @property integer $member_id
 * @property string $img_photo
 * @property string $photo_type
 */
class MemberPhoto extends CActiveRecord
{
	/**
	 ...
	 * @return MemberPhoto the static model class
	 */
