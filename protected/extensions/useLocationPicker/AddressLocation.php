...
class AddressLocation extends CWidget
{
	public $latId;
	public $lonId;
	public $height = "240px";
	...
	public function init() {
		...
		echo CHtml::hiddenField($className."[".$this->latId."]", $this->model->address_lat, array("class"=>"lat_".$randNumber));
		echo CHtml::hiddenField($className."[".$this->lonId."]", $this->model->address_lon, array("class"=>"lon_".$randNumber));
